...
describe("POST ==> /get-userTrade", () => {
  ...
  beforeAll(async () => {
    ...
    userId = user._id;
    jwtToken = JwtService.sign({ _id: userId });
    ...
    // Create some selling products for the user
  ...
  it("should get user's recently sold or bought products", async () => {
    // Arrange
    const requestBody = {
      isSellProducts: true,
